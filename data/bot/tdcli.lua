...
function setAuthPhoneNumber(phone_number, allow_flash_call, is_current_phone_number)
  tdcli_function ({
...
function checkAuthCode(code, first_name, last_name)
  tdcli_function ({
    ID = "CheckAuthCode",
    code_ = code,
...
function checkAuthPassword(password)
  tdcli_function ({
...
function requestAuthPasswordRecovery()
  tdcli_function ({
...
function recoverAuthPassword(recovery_code)
  tdcli_function ({
...
-- Returns authStateOk on success
-- @token Bot token
function checkAuthBotToken(token)
  tdcli_function ({
...
function setPassword(old_password, new_password, new_hint, set_recovery_email, new_recovery_email)
  tdcli_function ({
    ID = "SetPassword",
...
function getRecoveryEmail(password)
  tdcli_function ({
    ID = "GetRecoveryEmail",
    password_ = password
  }, dl_cb, nil)
...
function setRecoveryEmail(password, new_recovery_email)
  tdcli_function ({
    ID = "SetRecoveryEmail",
    password_ = password,
    new_recovery_email_ = new_recovery_email
...
-- Recovers password with recovery code sent to email
-- @recovery_code Recovery code to check
function recoverPassword(recovery_code)
  tdcli_function ({
    ID = "RecoverPassword",
...
-- @group_id Group identifier
function getGroupFull(group_id)
  tdcli_function ({
    ID = "GetGroupFull",
    group_id_ = getChatId(group_id).ID
  }, dl_cb, nil)
...
function getSecretChat(secret_chat_id)
  tdcli_function ({
    ID = "GetSecretChat",
...
function getMessages(chat_id, message_ids)
  tdcli_function ({
    ID = "GetMessages",
    chat_id_ = chat_id,
...
function getFilePersistent(persistent_file_id)
  tdcli_function ({
...
function searchPublicChats(username_prefix)
  tdcli_function ({
...
-- @limit Maximum number of chats to be returned
function searchChats(query, limit)
  if not limit or limit > 20 then
    limit = 20
  end
...
function addRecentlyFoundChat(chat_id)
  tdcli_function ({
...
function deleteRecentlyFoundChat(chat_id)
  tdcli_function ({
...
function deleteRecentlyFoundChats()
  tdcli_function ({
...
function getCommonChats(user_id, offset_chat_id, limit)
...
function getChatHistory(chat_id, from_message_id, offset, limit)
  if not limit or limit > 100 then
    limit = 100
  end
...
function searchChatMessages(chat_id, query, from_message_id, limit, filter)
  if not limit or limit > 100 then
    limit = 100
  end
...
-- @limit Maximum number of messages to be returned, can't be greater than 100
function searchMessages(query, offset_date, offset_chat_id, offset_message_id, limit)
  if not limit or limit > 100 then
    limit = 100
  end
...
-- @parameter Hidden parameter sent to bot for deep linking (https://api.telegra--M.org/bots#deep-linking)
...
function sendInlineQueryResultMessage(chat_id, reply_to_message_id, disable_notification, from_background, query_id, result_id)
  tdcli_function ({
...
function sendChatSetTtlMessage(chat_id, ttl)
  tdcli_function ({
...
function editMessageCaption(chat_id, message_id, reply_markup, caption)
  tdcli_function ({
...
function editMessageReplyMarkup(inline_message_id, reply_markup, caption)
  tdcli_function ({
...
-- @reply_markup New message reply markup
-- @input_message_content New text content of the message. Should be of type InputMessageText
function editInlineMessageText(inline_message_id, reply_markup, text, disable_web_page_preview)
  tdcli_function ({
...
-- @reply_markup New message reply markup
-- @caption New message content caption, 0-200 characters
function editInlineMessageCaption(inline_message_id, reply_markup, caption)
  tdcli_function ({
    ID = "EditInlineMessageCaption",
    inline_message_id_ = inline_message_id,
    reply_markup_ = reply_markup, -- reply_markup:ReplyMarkup
...
-- @inline_message_id Inline message identifier
-- @reply_markup New message reply markup
function editInlineMessageReplyMarkup(inline_message_id, reply_markup)
  tdcli_function ({
...
function getInlineQueryResults(bot_user_id, chat_id, latitude, longitude, query, offset)
  tdcli_function ({
...
function answerInlineQuery(inline_query_id, is_personal, cache_time, next_offset, switch_pm_text, switch_pm_parameter)
  tdcli_function ({
...
-- @url URL to be open
function getCallbackQueryAnswer(chat_id, message_id, text, show_alert, url)
  tdcli_function ({
...
function setGameScore(chat_id, message_id, edit_message, user_id, score, force)
  tdcli_function ({
    ID = "SetGameScore",
    chat_id_ = chat_id,
    message_id_ = message_id,
...
-- @score New score
-- @force Pass True to update the score even if it decreases. If score is 0, user will be deleted from the high scores table
function setInlineGameScore(inline_message_id, edit_message, user_id, score, force)
  tdcli_function ({
...
function getGameHighScores(chat_id, message_id, user_id)
  tdcli_function ({
...
-- @inline_message_id Inline message identifier
-- @user_id User identifier
function getInlineGameHighScores(inline_message_id, user_id)
  tdcli_function ({
...
function deleteChatReplyMarkup(chat_id, message_id)
  tdcli_function ({
...
function sendChatAction(chat_id, action, progress)
  tdcli_function ({
    ID = "SendChatAction",
    chat_id_ = chat_id,
    action_ = {
...
-- @chat_id Chat identifier
function sendChatScreenshotTakenNotification(chat_id)
  tdcli_function ({
...
function openMessageContent(chat_id, message_id)
  tdcli_function ({
...
-- @group_id Group identifier
function createGroupChat(group_id)
  tdcli_function ({
    ID = "CreateGroupChat",
    group_id_ = getChatId(group_id).ID
  }, dl_cb, nil)
...
-- @channel_id Channel identifier
function createChannelChat(channel_id)
  tdcli_function ({
...
function createSecretChat(secret_chat_id)
  tdcli_function ({
    ID = "CreateSecretChat",
    secret_chat_id_ = secret_chat_id
  }, dl_cb, nil)
...
function createNewChannelChat(title, is_supergroup, about)
  tdcli_function ({
...
function createNewSecretChat(user_id)
  tdcli_function ({
...
-- Creates new channel supergroup chat from existing group chat and send corresponding messageChatMigrateTo and messageChatMigrateFro--M. Deactivates group
...
function changeChatDraftMessage(chat_id, reply_to_message_id, text, disable_web_page_preview, clear_draft, parse_mode)
  local TextParseMode = getParseMode(parse_mode)
...
function addChatMembers(chat_id, user_ids)
  tdcli_function ({
    ID = "AddChatMembers",
    chat_id_ = chat_id,
    user_ids_ = user_ids -- vector
...
function cancelDownloadFile(file_id)
  tdcli_function ({
...
function setFileGenerationProgress(generation_id, ready)
  tdcli_function ({
...
-- @generation_id Identifier of the generation process
function finishFileGeneration(generation_id)
  tdcli_function ({
...
-- @invite_link Invite link to check. Should begin with "https://telegra--M.me/joinchat/"
function checkChatInviteLink(link)
  tdcli_function ({
...
-- Member will not be added until chat state will be synchronized with the server.
-- Member will not be added if application is killed before it can send request to the server
-- @invite_link Invite link to import. Should begin with "https://telegra--M.me/joinchat/"
...
function importContacts(phone_number, first_name, last_name, user_id)
  tdcli_function ({
    ID = "ImportContacts",
    contacts_ = {[0] = {
...
function deleteContacts(user_ids)
  tdcli_function ({
    ID = "DeleteContacts",
    user_ids_ = user_ids -- vector
  }, dl_cb, nil)
...
function getStickerSets(is_masks)
  tdcli_function ({
    ID = "GetStickerSets",
    is_masks_ = is_masks
  }, dl_cb, nil)
...
function getArchivedStickerSets(is_masks, offset_sticker_set_id, limit)
  tdcli_function ({
...
function getAttachedStickerSets(file_id)
  tdcli_function ({
...
function searchStickerSet(name)
  tdcli_function ({
    ID = "SearchStickerSet",
    name_ = name
  }, dl_cb, nil)
...
function updateStickerSet(set_id, is_installed, is_archived)
  tdcli_function ({
    ID = "UpdateStickerSet",
    set_id_ = set_id,
...
function viewTrendingStickerSets(sticker_set_ids)
  tdcli_function ({
...
function reorderStickerSets(is_masks, sticker_set_ids)
  tdcli_function ({
...
function getRecentStickers(is_attached)
  tdcli_function ({
...
function addRecentSticker(is_attached, sticker)
  tdcli_function ({
    ID = "AddRecentSticker",
    is_attached_ = is_attached,
...
function deleteRecentSticker(is_attached, sticker)
  tdcli_function ({
...
function clearRecentStickers(is_attached)
  tdcli_function ({
...
function getStickerEmojis(sticker)
  tdcli_function ({
    ID = "GetStickerEmojis",
    sticker_ = getInputFile(sticker)
  }, dl_cb, nil)
...
function addSavedAnimation(animation)
  tdcli_function ({
...
function deleteSavedAnimation(animation)
  tdcli_function ({
...
function getWebPagePreview(message_text)
  tdcli_function ({
...
-- scope = Chat(chat_id)|PrivateChats|GroupChats|AllChats|
function setNotificationSettings(scope, chat_id, mute_for, show_preview)
  tdcli_function ({
...
function deleteProfilePhoto(profile_photo_id)
  tdcli_function ({
...
function changePhoneNumber(phone_number, allow_flash_call, is_current_phone_number)
  tdcli_function ({
...
function resendChangePhoneNumberCode()
  tdcli_function ({
...
function checkChangePhoneNumberCode(code)
  tdcli_function ({
...
function terminateSession(session_id)
  tdcli_function ({
    ID = "TerminateSession",
...
function toggleGroupEditors(group_id, anyone_can_edit)
  tdcli_function ({
...
-- @username New value of username. Use empty string to remove username
function changeChannelUsername(channel_id, username)
  tdcli_function ({
...
function toggleChannelInvites(channel_id, anyone_can_invite)
  tdcli_function ({
...
function toggleChannelSignMessages(channel_id, sign_messages)
  tdcli_function ({
...
function changeChannelAbout(channel_id, about)
  tdcli_function ({
...
function pinChannelMessage(channel_id, message_id, disable_notification)
  tdcli_function ({
...
-- Needs editor privileges in the channel
-- @channel_id Identifier of the channel
function unpinChannelMessage(channel_id)
  tdcli_function ({
...
function getCreatedPublicChannels()
  tdcli_function ({
...
-- Closes secret chat
-- @secret_chat_id Secret chat identifier
function closeSecretChat(secret_chat_id)
  tdcli_function ({
    ID = "CloseSecretChat",
    secret_chat_id_ = secret_chat_id
  }, dl_cb, nil)
...
function registerDevice(device_token, token, device_token_set)
...
function setPrivacy(key, rule, allowed_user_ids, disallowed_user_ids)
...
-- See list of available options on https://core.telegra--M.org/tdlib/options
...
-- @ttl New account TTL
function changeAccountTtl(days)
  tdcli_function ({
    ID = "ChangeAccountTtl",
    ttl_ = {
      ID = "AccountTtl",
...
-- @chat_id Chat identifier
function getChatReportSpamState(chat_id)
  tdcli_function ({
...
function changeChatReportSpamState(chat_id, is_spam_chat)
  tdcli_function ({
...
function setBotUpdatesStatus(pending_update_count, error_message)
  tdcli_function ({
...
function sendText(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, text, disable_web_page_preview, parse_mode)
  local TextParseMode = getParseMode(parse_mode)
...
function sendAnimation(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, animation, width, height, caption)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendAudio(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, audio, duration, title, performer, caption)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendDocument(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, document, caption)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendSticker(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, sticker)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendVideo(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, video, duration, width, height, caption)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendVoice(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, voice, duration, waveform, caption)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendLocation(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, latitude, longitude)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendVenue(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, latitude, longitude, title, address, id)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendGame(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, bot_user_id, game_short_name)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
...
function sendForwarded(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, from_chat_id, message_id)
  tdcli_function ({
    ID = "SendMessage",
    chat_id_ = chat_id,
    reply_to_message_id_ = reply_to_message_id,
